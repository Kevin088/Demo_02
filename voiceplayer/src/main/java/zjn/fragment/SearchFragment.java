...
public class SearchFragment extends Fragment implements OnClickListener{
	...
	/**
	 * �÷���ʵ�ֵĹ����ǣ� ����Fragment���ɼ�ʱ��isVisibleToUser=false
	 * ����Fragment�ɼ�ʱ��isVisibleToUser=true
	 * �÷�����ϵͳ���ã���д�÷���ʵ���û��ɼ���ǰFragmentʱ�ٽ������ݵļ���
	 */
	@Override
	...
	private void search() {
		...
		if (TextUtils.isEmpty(content)) {
			Toast.makeText(mActivity, "������ؼ���", Toast.LENGTH_SHORT).show();
			return;
		}
		mPage = 0;
		mSearchProgressBar.setVisibility(View.VISIBLE);
