 ...
 * 
 * */
public class AndroidService_ extends Service {
	...
	private void doListen() {
		...
		try {
			...
			Log.e(TAG, serverSocket.getLocalSocketAddress().toString()+"服务器地址================");
			...
			while (mainThreadFlag) {
				...
				Log.e(TAG,client.getInetAddress()+":"+client.getPort()+"  客户端链接了。。。");
