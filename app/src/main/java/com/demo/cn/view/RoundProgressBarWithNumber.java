...
import com.demo.cn.app.App;
import com.demo.cn.utils.Utils;
...
public class RoundProgressBarWithNumber extends ProgressBar {
     ...
     * size of text (sp)
     */
    protected int mTextSize = Utils.sp2px(App.application,DEFAULT_TEXT_SIZE_SCORE);

    protected int mTextSizeOther= Utils.sp2px(App.application,DEFAULT_TEXT_SIZE_OTHER);
    /**
     * height of reached progress bar
     */
    protected int mReachedProgressBarHeight = Utils.dip2Px(App.application, DEFAULT_HEIGHT_REACHED_PROGRESS_BAR);
     ...
     */
    protected int mUnReachedProgressBarHeight = Utils.dip2Px(App.application,DEFAULT_HEIGHT_UNREACHED_PROGRESS_BAR);
    ...
    protected synchronized void onDraw(Canvas canvas)
    {
        ...
        int textHeight= (int) Math.ceil(fm.descent - fm.top) - 20;
